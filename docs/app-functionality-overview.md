...
- Architecture (as-built): `docs/architecture-as-built.md`
- Architecture (target/diagrams): `docs/architecture-diagrams.md`
- Product scope & epics: `docs/prd-summary.md`, `docs/complyvault-plugin-prd.md`
- Three-layer sign-off: `docs/three-layer-signoff.md`
- Compliance cockpit: `docs/compliance-cockpit.md`
- Ask ComplyVault: `docs/ask-complyvault.md`
- Onboarding: `docs/onboarding-flow.md`
- User-facing: `docs/USER_GUIDE.md`, `docs/FAQ.md`, `docs/user-journeys.md`
```
