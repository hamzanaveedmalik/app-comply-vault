...
> **Related:** CRD auto-population implementation detail lives in [`docs/autocomplete.md`](./autocomplete.md). This document is the master product PRD; the filename is historical.
