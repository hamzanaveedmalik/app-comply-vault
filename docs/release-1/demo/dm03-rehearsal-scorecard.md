...
- [x] Production routes redirect to auth (surface exists)
  - [x] `/needs-attention` (307)
  - [x] `/fail-closed` (307)
  - [x] `/partner/portfolio` (307)
  - [x] `/partner/complement` (307)
  - [x] `/partner/economics` (307)
  - [x] `/candidate-pack` (307)
  - [x] `/integrations/gmail-mail` (307)
  - [x] `/ask` (307)
